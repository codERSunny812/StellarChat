    ...
    <div className="mobileView h-screen overflow-hidden bg-[#1E1E1E] sticky top-0 left-0">
      ...
      <div className="topsection flex justify-between items-center text-white mx-[24px] my-[10px]">
        ...
        {isSearchBarVisible ? (
          ...
          <IoSearch
            className="h-10 w-10 border-2 border-white rounded-full p-1"
            onClick={handleSearchBar}
          />
        )}
      ...
      <div className="chatSection  bg-white rounded-6xl h-screen">
        <div className="chats my-1 py-3 h-[650px] overflow-scroll">
          ...
          {showState === CALL_SECTION && (
            <CallSection showAllUser={showAllUser} user={user} />
          )}

          {showState === CONTACT_SECTION && (
            <ContactSection
      ...
      <div className="endSection  bg-white w-full h-[80px] flex items-center justify-around capitalize fixed bottom-0 shadow-3xl font-semibold">
        <div
          className={`messageIcon flex flex-col items-center cursor-pointer ${
        ...
        <div
          className={`callIcon flex flex-col items-center cursor-pointer ${
        ...
        <div
          className={`contactIcon flex flex-col items-center cursor-pointer ${
        ...
        <div
          className={`settingIcon flex flex-col items-center cursor-pointer ${
